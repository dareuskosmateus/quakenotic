...
class GameProtocolUDP(asyncio.DatagramProtocol):
...
class XonoticProtocol(GameProtocolUDP):
    ...
    @GameProtocolUDP.if_transport
    @GameProtocolUDP.querying(default_challenge="getchallenge")
